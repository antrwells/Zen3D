...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0+2/x64-mswin64_140")
  ...
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "-1"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "D:/a/ruby-loco/ruby-loco/ruby-mswin")
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "x64-vcruntime140-ruby320"
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --disable-install-doc --prefix=D:\\a\\ruby-loco\\ruby-loco\\ruby-mswin --without-ext=+,dbm,gdbm --with-opt-dir=C:/vcpkg/installed/x64-windows"
